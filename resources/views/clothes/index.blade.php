                    ...
                    <table class="text-center w-full border-collapse">
                        <thead>
                            <tr>
                                ...
                                <th class="py-4 px-6 bg-gray-lightest dark:bg-gray-darkest font-bold uppercase text-lg text-gray-dark dark:text-gray-200 border-b border-grey-light dark:border-grey-dark">ジャンル</th>
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-lighter">
                                <td class="py-4 px-6 border-b border-gray-light dark:border-gray-600">{{$clothe->name}}</td>
